...
const frontendprojects = [  
    ...
    {title:"Project 1",description: "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is crisp in view.",img:img1},
...
const fullstackprojects = [
    {title:"fullstack Project 1",description: "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is crisp in view.",img:img1},
...
const androidprojects = [
    {title:"android Project 1",description: "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is crisp in view.",img:img1},

    {title:"android Project 2",description: "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is crisp in view.",img:img2},

    {title:"android Project 3",description: "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is crisp in view.",img:img3}  
]


 export { frontendprojects,fullstackprojects,androidprojects }